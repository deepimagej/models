...
* PARAMETER: RPN_ANCHOR_SCALES = (8, 16, 32, 64, 128)
*
*
...
* PARAMETER: POST_NMS_ROIS_INFERENCE = 2000
*
*
...
* PARAMETER: MINI_MASK_SHAPE = (100, 100)
*
*
...
*
* Image mean (RGB)
* PARAMETER: MEAN_PIXEL = [126.0, 126.0, 126.0]
*
*
...
* PARAMETER: MAX_GT_INSTANCES = 500
*
*
...
* PARAMETER: DETECTION_MAX_INSTANCES = 1000
*
*
* Minimum probability value to accept a detected instance
* PARAMETER: DETECTION_MIN_CONFIDENCE = 0.5
*
*
